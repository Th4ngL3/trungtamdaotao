async function notificationRoutes(fastify, options) {
  const controller = await require("../controllers/notificationController")(
    fastify
  );
  ...
  fastify.get(
    "/:id",
    { preValidation: [controller.verifyNotificationAccess] },
  ...
  fastify.post(
    "/",
    { preValidation: [fastify.isAdminOrTeacher] },
  ...
  fastify.post(
    ...
    controller.createEnrollmentNotification
  );
